...
export default (orchestrator: Orchestrator<any>) => 
  orchestrator.registerScenario("ping tests", async (s, t) => {
    ...
    const alice = alice_happ.cells.find(cell => cell.cellRole.includes('/my-dna.dna')) as Cell;
    const bob = bob_happ.cells.find(cell => cell.cellRole.includes('/my-dna.dna')) as Cell;
